	...
	config = function()
		...
		local buttons = {
			...
			val = {
				...
				dashboard.button("r", "󰥔  Recent file", "<cmd>Telescope oldfiles<CR>"),
				dashboard.button("s", "󰊄  Search text", "<cmd>Telescope live_grep<CR>"),
				dashboard.button("c", "  Configuration", "<cmd>e $MYVIMRC | :cd %:p:h | split . | wincmd k | pwd<CR>"),
